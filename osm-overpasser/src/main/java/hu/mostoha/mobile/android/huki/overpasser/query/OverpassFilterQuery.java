...
public class OverpassFilterQuery extends AbstractOverpassSubQuery {
    ...
    public OverpassFilterQuery relBy(String name) {
        applySeparator();
        builder.brackets("rel", name);
        prepareNext();

        return this;
    }

    public OverpassFilterQuery wayBy(String name) {
        applySeparator();
        builder.brackets("way", name);
        prepareNext();

        return this;
    }

    public OverpassFilterQuery nodeBy(String name) {
        applySeparator();
        builder.brackets("node", name);
        prepareNext();
     ...
     * @return the current query object
     */
    public OverpassFilterQuery tagRegex(String name, String value, boolean caseSensitive) {
        builder.regexMatches(name, value, caseSensitive);
