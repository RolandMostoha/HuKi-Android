...
val localLandscapes = listOf(
    ...
    Landscape(
        ...
        type = LandscapeType.PLATEAU_WITH_WATER,
        center = Location(46.9474441, 17.7261084)
    ),
    Landscape(
        osmId = "279660398",
        name = "Aggteleki-karszt",
        type = LandscapeType.CAVE_SYSTEM,
    ...
    Landscape(
        osmId = "279663379",
        name = "Gerecse-hegység",
        type = LandscapeType.MOUNTAIN_RANGE_LOW,
        center = Location(47.6177834, 18.5489089)
    ),
    Landscape(
        osmId = "279665573",
        name = "Keszthelyi-hegység",
        type = LandscapeType.PLATEAU_WITH_WATER,
    ...
    Landscape(
        ...
        name = "Naszály",
        type = LandscapeType.MOUNTAIN_RANGE_LOW,
        center = Location(47.8323170, 19.1394057)
    ),
    Landscape(
        osmId = "279590728",
        name = "Cserhát",
    ...
    Landscape(
        osmId = "279593581",
        name = "Heves-Borsodi-dombság",
        type = LandscapeType.MOUNTAIN_RANGE_LOW,
        center = Location(48.1220709, 20.1976971)
    ),
    Landscape(
        osmId = "279651467",
        name = "Gödöllői-dombság",
        type = LandscapeType.MOUNTAIN_RANGE_LOW,
    ...
    Landscape(
        osmId = "279667079",
        name = "Villányi-hegység",
        type = LandscapeType.MOUNTAIN_RANGE_LOW,
        center = Location(45.8827512, 18.2730710)
    ),
    Landscape(
        osmId = "300323308",
        name = "Kőszegi-hegység",
        type = LandscapeType.MOUNTAIN_RANGE_LOW,
