...
/**
 * OsmDroid ScaleBarOverlay clone to support stroked scale bar.
 */

public class HukiScaleBarOverlay extends Overlay implements GeoConstants {
    ...
    int yOffset = 10;
    double minZoom = 0;
    int textBarSpacingExtra = 4;
    float textLetterSpacing = 0.025f;
    ...
    private HukiScaleBarOverlay(final MapView pMapView, final Context pContext, final int pMapWidth, final int pMapHeight) {
        ...
        this.textPaint.setLetterSpacing(textLetterSpacing);
        ...
        this.textStrokePaint.setStrokeMiter(10f);
    ...
    public void draw(Canvas c, Projection projection) {
        ...
        // Draw bar stroke
        c.drawPath(barPath, barStrokePaint);
    ...
    private void drawLatitudeText(final Canvas canvas, final Projection projection) {
        ...
        final int xTextSpacing = (int) (sTextBoundsRect.height() / 5.0) + textBarSpacingExtra;
        ...
        // Draw stroked text
        canvas.drawText(xMsg, x, y, textStrokePaint);
