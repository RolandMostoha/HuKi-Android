...
class PlaceFinderAdapter(
    ...
    private val onAttributionClick: (() -> Unit)? = null,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        when (placeFinderItem) {
            ...
            is PlaceFinderItem.Attribution -> {
                val binding = ViewAttributionBinding.inflate(parent.context.inflater, parent, false)
                binding.attributionLogo.setImageResource(R.drawable.ic_location_iq_logo)
                binding.attributionContainer.setOnClickListener {
                    onAttributionClick?.invoke()
                }
                view = binding.root
            }
        }
