...
/**
 * The exact copy of [{@link org.osmdroid.views.overlay.mylocation.MyLocationNewOverlay}].
 * With the following changes:
 * - setLocation only sets the location, does not animate the map
 * - The menu options related code is removed
 */
public class MyLocationOverlayBase extends Overlay implements IMyLocationConsumer, Snappable {
    ...
    public MyLocationOverlayBase(IMyLocationProvider myLocationProvider, MapView mapView) {
        super();
