...
class OverpassLandscapeRepositoryTest {
    ...
    @Inject
    lateinit var repository: OverpassLandscapeRepository

    @Test
    fun getLandscapes() = runBlocking {
        val result = repository.getLandscapes()
